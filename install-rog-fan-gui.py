#!/usr/bin/env python3
"""
install-rog-fan-gui — GTK3-Wizard für ROG Fan Suite Installation
ruft install-rog-fan.sh via pkexec auf, zeigt Live-Output
Track 2 v0.7
"""
import os
import re
...
TR = {
    "de": {
        "title":            "ROG Fan Suite — Installer",
        "subtitle":         "ASUS ROG Lüftersteuerung",
        "intro_header":     "Diese Suite installiert:",
        "comp_asusctl":     "asusctl (Backend-Daemon)",
        "comp_wrapper":     "rog-fan (Terminal-Wrapper)",
        "comp_gui":         "rog-fan-gui (GTK-Oberfläche)",
        "comp_keyd":        "rog-fan-keyd (Fan-Taste mit OSD)",
        "comp_services":    "systemd-Services (Boot + Resume)",
        "lang_label":       "Sprache:",
        "lang_de":          "Deutsch",
        "lang_en":          "English",
        ...
        "about_title":      "ROG Fan Suite Installer",
        "about_comment":    "Grafischer Installer für die ROG Fan Suite",
    },
    "en": {
        "title":            "ROG Fan Suite — Installer",
        ...
        "comp_asusctl":     "asusctl (backend daemon)",
        "comp_wrapper":     "rog-fan (terminal wrapper)",
        "comp_gui":         "rog-fan-gui (GTK interface)",
        "comp_keyd":        "rog-fan-keyd (Fan key with OSD)",
        "comp_services":    "systemd services (boot + resume)",
        "lang_label":       "Language:",
        "lang_de":          "Deutsch",
        "lang_en":          "English",
        ...
        "about_title":      "ROG Fan Suite Installer",
        "about_comment":    "Graphical installer for the ROG Fan Suite",
    },
}
...
class InstallerWindow(Gtk.Window):
    ...
    def _build_body(self):
        ...
        for key in ("comp_asusctl", "comp_wrapper", "comp_gui",
                    "comp_keyd", "comp_services"):
    ...
    def _start_subprocess(self, args, action_name):
        try:
            ...
            if shutil.which("stdbuf"):
                # Wir wrappen den Befehl nach 'pkexec' so dass das Skript line-buffered läuft
